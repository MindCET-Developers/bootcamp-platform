  ...
  if (gesEvent.docs[0]) {
    ...
    const created = await payload.create({
      ...
      data: {
        ...
        startsAt: new Date('2026-08-12T14:00:00Z'),
        endsAt: new Date('2026-08-12T17:00:00Z'),
        city: 'Seoul',
  ...
  if (mindcetEvent.docs[0]) {
    ...
    const created = await payload.create({
      ...
      data: {
        ...
        endsAt: new Date('2026-08-13T12:00:00Z'),
        city: 'Seoul',
        venue: 'Edu+ Korea',
        timezone: 'Asia/Seoul',
        hero: {
  ...
  const gesSessions = [
    {
      ...
      startsAt: new Date('2026-08-12T14:00:00Z'),
      endsAt: new Date('2026-08-12T14:10:00Z'),
      type: 'Talk',
      location: 'Main Stage',
    ...
    },
    {
      ...
      startsAt: new Date('2026-08-12T14:10:00Z'),
    ...
    },
    {
      ...
      startsAt: new Date('2026-08-12T14:30:00Z'),
      endsAt: new Date('2026-08-12T14:50:00Z'),
      type: 'Talk',
      location: 'Main Stage',
    ...
    },
    {
      ...
      startsAt: new Date('2026-08-12T14:50:00Z'),
      endsAt: new Date('2026-08-12T15:40:00Z'),
      type: 'Panel',
      location: 'Main Stage',
    ...
    },
    {
      ...
      startsAt: new Date('2026-08-12T15:40:00Z'),
    ...
    },
    {
      ...
      startsAt: new Date('2026-08-12T16:00:00Z'),
      endsAt: new Date('2026-08-12T16:20:00Z'),
      type: 'Talk',
      location: 'Main Stage',
    ...
    },
    {
      ...
      startsAt: new Date('2026-08-12T16:20:00Z'),
      endsAt: new Date('2026-08-12T16:40:00Z'),
      type: 'Talk',
      location: 'Main Stage',
    ...
    },
    {
      ...
      startsAt: new Date('2026-08-12T16:40:00Z'),
      endsAt: new Date('2026-08-12T17:00:00Z'),
      type: 'Panel',
      location: 'Main Stage',
  ...
  const mindcetSessions = [
    {
      ...
      startsAt: new Date('2026-08-13T10:00:00Z'),
      endsAt: new Date('2026-08-13T10:20:00Z'),
      type: 'Networking',
      location: 'Main Hall',
    ...
    },
    {
      ...
      startsAt: new Date('2026-08-13T10:20:00Z'),
      endsAt: new Date('2026-08-13T10:45:00Z'),
      type: 'Talk',
      location: 'Main Stage',
    ...
    },
    {
      ...
      startsAt: new Date('2026-08-13T10:45:00Z'),
      endsAt: new Date('2026-08-13T11:10:00Z'),
      type: 'Talk',
      location: 'Main Stage',
    ...
    },
    {
      ...
      startsAt: new Date('2026-08-13T11:10:00Z'),
      endsAt: new Date('2026-08-13T11:35:00Z'),
      type: 'Talk',
      location: 'Main Stage',
    ...
    },
    {
      ...
      startsAt: new Date('2026-08-13T11:35:00Z'),
      endsAt: new Date('2026-08-13T12:00:00Z'),
      type: 'Panel',
      location: 'Main Stage',
